...
type ApiPrediction = { predictionId: string | null; marketGroup: string; availability: string; marketType: string | null; marketValue: string | null; selection: string | null; shortSelection: string | null; confidence: number | null; odds: number | null; result?: unknown; valueAnalysis?: OracleMarket['valueAnalysis'] };
